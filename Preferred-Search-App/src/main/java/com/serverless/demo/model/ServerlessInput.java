...
public class ServerlessInput {
    ...
    private List<Brick> queryStringParameters;
    ...
    public List<Brick> getQueryStringParameters() {
		return queryStringParameters;
	}
	public void setQueryStringParameters(List<Brick> queryStringParameters) {
